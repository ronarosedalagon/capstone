    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-md-offset-3">
                ...
                <form action="add_scholarship" method="post" enctype="multipart/form-data">
                ...
                @csrf
                    ...
                    <div class="row form-group ">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Enter Scholarship Name" value="{{ old('name') }}">
                        ...
                        <div class="form-group">
                            <a href="/admin-scholarship/"> <button type="button" class="btn btn-danger float-right"> BACK </button></a>
