    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-md-offset-3">
                ...
                <form action="add_publication" method="post" enctype="multipart/form-data">
                ...
                @csrf
                    ...
                    <div class="row form-group ">
                        ...
                        <div class="form-group">
                            <a href="/admin-publication/"> <button type="button" class="btn btn-danger float-right"> BACK </button></a>
