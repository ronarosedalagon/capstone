        ...
        <h4>ID REISSUANCE REQUEST FORM</h4>
           ...
           <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                    <label><b>Step 1:</b> Prepare the files needed:</label><br>
                        <label><i><b>1.1</b> Affidavit of Loss that is notarized by an attorney</i></label><br>
                        <label><i><b>1.2</b> Payment Receipt from the school cashier for ID Reissuance</i></label><br>
                    <label><b>Step 2:</b> Scan and Upload the documents </label><br>
                    <label><b>Step 3:</b> Click submit and follow the instructions at the confirmation pane</label><br>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="GET" action="{{route ('reissuance_confirm_request')}}">
