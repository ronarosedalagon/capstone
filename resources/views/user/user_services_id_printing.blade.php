...
<div class="row">
    ...
    <div class="card">
        ...
        <div class="col-sm">
            ...
            <div class="col-sm">
            <a href="/user-services/IDcard-Printing" class="btn btn-secondary btn-block active" role="button" aria-pressed="true">ID Application Form</a>
            </div>
            <div class="col-sm">
           ...
           <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <label><b>Step 2:</b> Fill out the ID Application Form</label><br>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="GET" action="{{route ('confirm_request')}}">
