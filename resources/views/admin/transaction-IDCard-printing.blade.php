...
<div class="row">
    ...
    <div class="card">
        <div class="card-header col-md-12 text-right">
            ...
            <a href="/admin-IDCard-printing" class="btn btn-secondary btn-md active" role="button" aria-pressed="true">Printing</a>
        ...
        <h4 class="card-title text-center">ID-CARD SERVICES | PRINTING </h4>
        <hr>
        <a href="" class="btn btn-info float-left btn-md" role="button" aria-pressed="true">PENDING</a>
        <a href="" class="btn btn-success float-left btn-md" role="button" aria-pressed="true">PRINTED</a>
        <a href="{{route('export_user')}}" class="btn btn-secondary float-right btn-md" role="button" aria-pressed="true">EXPORT XLS FILE</a>
            ...
            <table class="table table-striped table-bordered">
                ...
                @foreach ($studentsdata as $item)
                    <tr>
                        ...
                        <td>
                            <img src="{{ asset('storage/assets/student_idphotos/'.$item->student_photo) }}" width="70px" height="70px" alt="{{ $item->student_photo}}">
                        </td>
                        <td>{{ $item->status}}</td>
                        <td>
                         <button type="button" data-toggle="modal" data-target="#exampleModal" class="btn btn-md btn-success"> PRINTED </button>
                        </td>    
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form method="GET" action="/print-status/{{$item->student_id}}/{{ $item->status}}">
          
        <div class="modal-body">
            <p>Are you sure that the student id has been printed already? </p
            <label> Click <b>CONFIRM BUTTON</b> to proceed. </label> <br> <br>
