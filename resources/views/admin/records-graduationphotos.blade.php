    ...
    <div class="col-md-12" st>
        <div class="card">
            <div class="card-header">
                ...
                <a href=""><button type="button" class="btn btn-secondary" >Forms</button></a>
                <a href=""><button type="button" class="btn btn-secondary" style="margin-left:-4%;">Forms</button></a>
                <a href=""><button type="button" class="btn btn-secondary" style="margin-left:-8%;">Forms</button></a>
               
                </div>
                <!-- dashboard header title -->
                <h4 class="card-title"> Graduation Photos </h4>
            </div>
            <div class="card-body">
